...
FFMPEG_PATH = "C:/Program Files/ffmpeg-2025-02-13-git-19a2d26177-full_build/bin/ffmpeg.exe"  # Change this to the full path if needed (e.g., r"C://ffmpeg//bin//ffmpeg.exe")
